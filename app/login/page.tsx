    ...
    <main className="min-h-screen bg-white flex flex-col items-center justify-center px-5">
      <div className="w-full max-w-sm">
        <div className="mb-8 text-center">
          ...
          <h1 className="text-xl font-extrabold text-sf-text">Masuk ke Dashboard</h1>
          <p className="mt-1 text-sm text-sf-text-secondary">Kelola tokomu dari sini</p>
        </div>
        ...
        <p className="mt-5 text-center text-sm text-sf-text-secondary">
          Belum punya toko? <Link href="/register" className="font-medium text-sf-red">Daftar</Link>
        </p>
        <p className="mt-2 text-center text-sm text-sf-text-secondary">
          <Link href="/pelanggan/login" className="font-medium text-sf-text-secondary underline">Masuk sebagai Pelanggan</Link>
        </p>
      </div>
    </main>
  );
