...
export default function LoginPage() {
  ...
  return (
    <>
      <Navbar />
      <main className="min-h-[calc(100vh-4rem)] bg-[#FAF6ED] lg:flex">
        ...
        <div className="relative hidden overflow-hidden bg-[#1C1410] px-14 py-16 lg:flex lg:w-1/2 lg:flex-col lg:justify-between">
          ...
          <div
            ...
            style={{
              backgroundImage:
                "radial-gradient(circle, #E8A33D 1px, transparent 1px)",
          ...
          <div className="relative">
            ...
            <p className="mt-4 max-w-xs text-sm leading-relaxed text-[#FAF6ED]/60">
              Kelola menu, pantau pesanan, dan urus tokomu — semua dari satu
              tempat, tanpa ribet.
            </p>
          </div>
        ...
        <div className="flex flex-1 items-center justify-center px-6 py-16">
          <div className="w-full max-w-sm">
            <div className="mb-8">
              <h2 className="font-serif text-2xl font-semibold text-[#1C1410]">
                Masuk ke tokomu
              </h2>
            ...
            <form onSubmit={handleSubmit} className="space-y-4">
              <div>
                <label className="mb-1.5 block text-sm font-medium text-[#1C1410]">
                  Email
                </label>
                <input
                  required
              ...
              {error && (
                <p className="rounded-lg bg-[#C1440E]/8 px-3 py-2 text-sm text-[#C1440E]">
                  {error}
                </p>
              )}
            ...
            <p className="mt-6 text-center text-sm text-[#1C1410]/50">
              Belum punya toko?{" "}
              <a href="/register" className="font-medium text-[#C1440E] hover:underline">
                Daftar di sini
              </a>
            </p>
          </div>
